...
public class JInputJoystick {
    ...
    public JInputJoystick(Controller.Type controllerType) {
        initialize();
        initController(controllerType, null,-1);
    }
     ...
     * @param controllerType Desired controller type.
     */
    public JInputJoystick(Controller.Type controllerType,int index) {
        initialize();
        initController(controllerType, null,index);
    }
     ...
     */
    public JInputJoystick(Controller.Type controllerType_1, Controller.Type controllerType_2,int index) {
        initialize();
        initController(controllerType_1, controllerType_2,index);
    }
    ...
    public JInputJoystick(Controller.Type controllerType_1, Controller.Type controllerType_2) {
        initialize();
        initController(controllerType_1, controllerType_2,-1);
    }
     ...
     * @param controllerType_1 Desired controller type.
     */
    private void initController(Controller.Type controllerType_1, Controller.Type controllerType_2,int index)
    {
        ...
        for(int i = 0; i < controllers.length; i++) {
            ...
            if(joysticks.contains(joystick)) {
                ...
                if (joystick.getType() == controllerType_1 && controllerType_2 == null) {
                    controller = joystick;
                    controllerArrayIndex = i;
                    controllerTypeIndex = index;
                }
