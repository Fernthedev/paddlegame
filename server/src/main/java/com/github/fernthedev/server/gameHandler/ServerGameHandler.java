...
public class ServerGameHandler implements Runnable {
    ...
    private static ServerSpawn spawn;
    ...
    public ServerGameHandler(Server server, EntityHandler entityHandler, GameMechanics gameMechanics) {
        this.server = server;
        spawn = new ServerSpawn();
        ServerGameHandler.gameMechanics = gameMechanics;
