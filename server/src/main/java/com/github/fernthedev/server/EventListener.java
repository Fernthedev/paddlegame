    ...
    public void received(Object p) {
        ...
        if(p instanceof PongPacket) {
           ...
           // System.out.println("Received player information " + infoPacket.getPlayerObject());
            ...
            if(oldPlayer == null) oldPlayer = new EntityPlayer(UniversalHandler.WIDTH / 2 - 32, UniversalHandler.HEIGHT / 2 - 32, ID.PLAYER,new Velocity(0),new Velocity(0), GameObject.entities);
